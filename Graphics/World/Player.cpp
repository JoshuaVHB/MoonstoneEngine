...
void Player::handleKeyboardEvents() {
	...
	if (wKbd->isKeyPressed(VK_SPACE)) {
		m_positionDelta = XMVectorSetY(m_positionDelta, XMVectorGetY(m_positionDelta) + 0.5f);
	}
	...
	if (wKbd->isKeyPressed(Keyboard::letterCodeFromChar('q')) || wKbd->isKeyPressed(Keyboard::letterCodeFromChar('a'))) {
		m_positionDelta = XMVectorSetZ(m_positionDelta, XMVectorGetZ(m_positionDelta) - XMVectorGetZ(horizontalDir));
		m_positionDelta = XMVectorSetX(m_positionDelta, XMVectorGetX(m_positionDelta) - XMVectorGetX(horizontalDir));
	}
	...
	{
		m_positionDelta = XMVectorSetZ(m_positionDelta, XMVectorGetZ(m_positionDelta) - XMVectorGetZ(forwardDir));
		m_positionDelta = XMVectorSetX(m_positionDelta, XMVectorGetX(m_positionDelta) - XMVectorGetX(forwardDir));
	}
